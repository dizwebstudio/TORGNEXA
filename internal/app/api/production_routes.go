...
type productionRouteDependencies struct {
	...
	marketplaceListing     *marketplacelistingrepo.Repository
	marketplaceGrowth      *marketplacegrowthrepo.Repository
...
func newProductionRoutes(deps productionRouteDependencies) []ProtectedRoute {
	...
	routes = append(routes, newCustomerServiceRoutes(deps.customerService, deps.auditService)...)
