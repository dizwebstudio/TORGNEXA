...
func TestRepositoryCatalogPasses(t *testing.T) {
	...
	expected := []string{
		...
		"marketplace_listing_workspace",
		"marketplace_growth_management",
		"financial_completeness_sources",
		"customer_service_inbox",
		"mobile_warehouse_fulfillment",
		"mass_catalog_management",
		"ecosystem_support",
		"marketplace_publication_async_identity",
		"sync_outbound_version_fence",
		"marketplace_operation_action_runtime",
		"workspace_member_idempotency_digest",
	}
