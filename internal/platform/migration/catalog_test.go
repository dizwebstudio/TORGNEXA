...
func TestRepositoryCatalogPasses(t *testing.T) {
	...
	expected := []string{
		...
		"ai_provider_qwen_deepseek", "trust_control_plane", "social_publication_runtime", "payments_core", "payments_remote_id_lookup", "ai_provider_claude", "ai_provider_local_runtime", "ai_provider_gemini_grok",
	}
