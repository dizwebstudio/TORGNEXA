...
func TestRepositoryCatalogPasses(t *testing.T) {
	...
	expected := []string{
		...
		"upload_security_pg18_compat", "audit_realtime_lookup_index", "workflow_automation", "payment_reconciliation_worker", "returns_cancellations_refunds", "wms_operator_tasks",
	}
