...
var capabilityDefinitions = map[Capability]CapabilityDefinition{
	...
	"marketplace.listings.taxonomy.read":    readable("marketplace.listings.taxonomy.read", families(FamilyMarketplace)),
	"marketplace.listings.content.write":    writeSensitive("marketplace.listings.content.write", families(FamilyMarketplace)),
	"marketplace.listings.attributes.write": writeSensitive("marketplace.listings.attributes.write", families(FamilyMarketplace)),
	"marketplace.listings.media.write":      writeSensitive("marketplace.listings.media.write", families(FamilyMarketplace)),
	"marketplace.listings.batch.write":      writeSensitive("marketplace.listings.batch.write", families(FamilyMarketplace)),
	"marketplace.listings.status.read":      readable("marketplace.listings.status.read", families(FamilyMarketplace)),
	...
	"logistics.batches.cancel":             writeSensitive("logistics.batches.cancel", families(FamilyLogistics)),
	"logistics.batches.read":               readable("logistics.batches.read", families(FamilyLogistics)),
	"logistics.batches.orders.read":        readable("logistics.batches.orders.read", families(FamilyLogistics)),
	"logistics.orders.read":                readable("logistics.orders.read", families(FamilyLogistics)),
	"logistics.orders.search":              readable("logistics.orders.search", families(FamilyLogistics)),
	...
	"logistics.batches.archive.read":       readable("logistics.batches.archive.read", families(FamilyLogistics)),
	"logistics.batches.unarchive":          writeSensitive("logistics.batches.unarchive", families(FamilyLogistics)),
	"logistics.batches.sending_date.write": writeSensitive("logistics.batches.sending_date.write", families(FamilyLogistics)),
	"logistics.orders.restore":             writeSensitive("logistics.orders.restore", families(FamilyLogistics)),
