...
func TestCalculateIsDeterministicAndDoesNotCountPayoutAsRevenue(t *testing.T) {
	in := Input{OrganizationID: "org-1", WorkspaceID: "ws-1", Basis: BasisOrderAccrual, From: time.Date(2026, 8, 1, 0, 0, 0, 0, time.UTC), To: time.Date(2026, 8, 2, 0, 0, 0, 0, time.UTC), Orders: []OrderFact{testOrder("o-1", "channel:store", "fulfilled", 10000, 500, 9500)}, Settlements: []SettlementFact{{ID: "s-fee", SourceSystem: "market", SourceAccount: "a", ProviderRef: "fee-1", OrderID: "o-1", ChannelRef: "channel:store", Kind: "fee", AmountMinor: -1000, Currency: "RUB", OccurredAt: time.Date(2026, 8, 1, 12, 0, 0, 0, time.UTC)}, {ID: "s-payout", SourceSystem: "market", SourceAccount: "a", ProviderRef: "payout-1", OrderID: "o-1", ChannelRef: "channel:store", Kind: "payout", AmountMinor: 8500, Currency: "RUB", OccurredAt: time.Date(2026, 8, 1, 13, 0, 0, 0, time.UTC)}}}
