...
test("navigation is capability-aware", () => {
  ...
  assert.deepEqual(visible.map((item) => item.id), ["dashboard", "catalog", "mass-catalog", "publication-quality", "marketplace-publication", "marketplace-listing", "orders", "pricing"]);
