...
const roleCapabilities: Readonly<Record<string, readonly string[]>> = {
  admin: ["operations.realtime.read", "products.read", "products.write", "orders.read", "stock.read", "stock.write", "connectors.read", "connectors.accounts.read", "connectors.accounts.write", "sync.read", "sync.write", "approvals.read", "approvals.write", "compliance.read", "notifications.read", "reports.read", "audit.read", "settings.read", "settings.members.read", "settings.members.write", "settings.security.read", "settings.security.write", "settings.identity_providers.read", "settings.identity_providers.write", "settings.ai_providers.read", "settings.ai_providers.write", "settings.mcp_accounts.read", "settings.mcp_accounts.write", "ai.analyze", "counterparties.read", "webhooks.read", "webhooks.write", "plugins.read", "settlements.read", "fx.read", "cloud.subscription.read", "privacy.requests.write"],
  manager: ["operations.realtime.read", "products.read", "orders.read", "stock.read", "connectors.read", "sync.read", "approvals.read", "compliance.read", "notifications.read", "reports.read", "settings.ai_providers.read", "settings.mcp_accounts.read", "ai.analyze", "counterparties.read", "webhooks.read", "plugins.read", "settlements.read", "fx.read"],
  operator: ["operations.realtime.read", "products.read", "orders.read", "stock.read", "connectors.read", "sync.read", "notifications.read", "settings.ai_providers.read", "settings.mcp_accounts.read", "ai.analyze", "counterparties.read", "webhooks.read", "plugins.read"],
  viewer: ["operations.realtime.read", "products.read", "orders.read", "stock.read", "notifications.read", "reports.read", "settings.ai_providers.read", "settings.mcp_accounts.read", "counterparties.read", "settlements.read", "fx.read"],
};
