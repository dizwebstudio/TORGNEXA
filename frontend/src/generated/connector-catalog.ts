...
export const connectorCatalog: readonly ConnectorCatalogEntry[] = [
  ...
  },
  {
    ...
    runtime: {
      stage: "separate_surface",
      surface: "logistics",
      operationalCapabilities: ["logistics.rates.read", "logistics.shipment.cancel", "logistics.track.read", "pickup.points.read"],
      sync: [
      ],
    },
  },
  ...
  },
  {
    ...
    runtime: {
      stage: "separate_surface",
      surface: "logistics",
      operationalCapabilities: ["logistics.track.read", "pickup.points.read"],
      sync: [
      ],
    },
  },
