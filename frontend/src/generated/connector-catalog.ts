...
export const connectorCatalog: readonly ConnectorCatalogEntry[] = [
  ...
  },
  {
    ...
    capabilities: ["ads.read", "inventory.read", "orders.read", "prices.write", "products.read", "products.write"],
    authKinds: ["api_key"],
    runtime: {
      stage: "ready",
      surface: "integrations",
      operationalCapabilities: ["ads.read", "inventory.read", "orders.read", "prices.write", "products.read", "products.write"],
      sync: [
        {entityType: "products", directions: ["inbound"]},
  ...
  },
  {
    ...
    capabilities: ["ads.read", "inventory.read", "inventory.write", "orders.read", "prices.write", "products.read", "products.write"],
    authKinds: ["bearer"],
    runtime: {
      stage: "ready",
      surface: "integrations",
      operationalCapabilities: ["ads.read", "inventory.read", "inventory.write", "orders.read", "prices.write", "products.read", "products.write"],
      sync: [
        {entityType: "products", directions: ["inbound"]},
        {entityType: "prices", directions: ["outbound"]},
        {entityType: "inventory", directions: ["inbound", "outbound"]},
