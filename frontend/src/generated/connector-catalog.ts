...
export const connectorCatalog: readonly ConnectorCatalogEntry[] = [
  ...
  },
  {
    ...
    runtime: {
      stage: "ready",
      surface: "integrations",
      operationalCapabilities: ["inventory.read", "orders.read", "prices.read", "products.read"],
      sync: [
        {entityType: "products", directions: ["inbound"]},
        {entityType: "prices", directions: ["inbound"]},
  ...
  },
  {
    ...
    runtime: {
      stage: "ready",
      surface: "integrations",
      operationalCapabilities: ["inventory.read", "orders.read", "products.read"],
      sync: [
        {entityType: "products", directions: ["inbound"]},
        {entityType: "inventory", directions: ["inbound"]},
        {entityType: "orders", directions: ["inbound"]},
  ...
  },
  {
    ...
    capabilities: ["ads.read", "inventory.read", "inventory.write", "orders.read", "orders.status.write", "prices.write", "products.read", "products.write"],
    authKinds: ["api_key"],
    runtime: {
      stage: "ready",
      surface: "integrations",
      operationalCapabilities: ["ads.read", "inventory.read", "inventory.write", "orders.read", "orders.status.write", "prices.write", "products.read", "products.write"],
      sync: [
        {entityType: "products", directions: ["inbound"]},
  ...
  },
  {
    ...
    runtime: {
      ...
      runtimeConfigTemplate: {"group_id":12345},
      socialTextMaxRunes: 16384,
    },
  },
  {
    id: "wildberries",
    ...
    capabilities: ["ads.manage", "ads.read", "inventory.read", "inventory.write", "orders.read", "orders.status.write", "prices.write", "products.read", "products.write"],
    authKinds: ["bearer"],
    runtime: {
      stage: "ready",
      surface: "integrations",
      operationalCapabilities: ["ads.manage", "ads.read", "inventory.read", "inventory.write", "orders.read", "orders.status.write", "prices.write", "products.read", "products.write"],
      sync: [
        {entityType: "products", directions: ["inbound"]},
        {entityType: "prices", directions: ["outbound"]},
        {entityType: "inventory", directions: ["inbound", "outbound"]},
