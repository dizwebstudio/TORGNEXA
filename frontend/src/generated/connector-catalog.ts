...
export const connectorCatalog: readonly ConnectorCatalogEntry[] = [
  ...
  },
  {
    ...
    capabilities: ["logistics.batches.create", "logistics.batches.read", "logistics.batches.submit", "logistics.label.read", "logistics.rates.read", "logistics.return.create", "logistics.return.separate.create", "logistics.shipment.cancel", "logistics.shipment.create", "logistics.track.read", "pickup.points.read"],
    authKinds: ["api_key"],
    runtime: {
      stage: "separate_surface",
      surface: "logistics",
      operationalCapabilities: ["logistics.batches.create", "logistics.batches.read", "logistics.batches.submit", "logistics.label.read", "logistics.rates.read", "logistics.return.create", "logistics.return.separate.create", "logistics.shipment.cancel", "logistics.shipment.create", "logistics.track.read", "pickup.points.read"],
      sync: [
      ],
    },
  },
