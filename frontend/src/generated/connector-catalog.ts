...
export const connectorCatalog: readonly ConnectorCatalogEntry[] = [
  ...
  },
  {
    ...
    capabilities: ["inventory.read", "orders.read", "prices.read", "products.read", "products.write"],
    authKinds: ["basic"],
    runtime: {
      stage: "ready",
      surface: "integrations",
      operationalCapabilities: ["inventory.read", "orders.read", "prices.read", "products.read", "products.write"],
      sync: [
        {entityType: "products", directions: ["inbound", "outbound"]},
