...
export const navigationItems: readonly NavigationItem[] = [
  ...
  {id: "mass-catalog", label: "Массовый каталог", path: "/catalog/bulk", capability: "products.read", risk: "WRITE_SENSITIVE", icon: "catalog"},
  ...
  {id: "mobile-warehouse", label: "Мобильный склад", path: "/warehouse/mobile", capability: "stock.read", risk: "WRITE_SENSITIVE", icon: "warehouse", shortcut: "G H"},
