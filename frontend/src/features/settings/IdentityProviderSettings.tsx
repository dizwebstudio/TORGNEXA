...
export function IdentityProviderSettings(){
 ...
 return <section className="panel settings-card identity-provider-settings">
  ...
  {action.isError?<ErrorBlock>Операция не выполнена: обновите данные и проверьте validation evidence.</ErrorBlock>:null}
 </section>;
}
