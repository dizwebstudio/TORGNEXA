    ...
    <div className="docs-layout">
      ...
      <main className="docs-content">
        ...
        <DocSection id="inventory-incidents" title="Остатки и инциденты" intro="Остатки отражают доступное количество, резервы, состояние складов и исключения fulfillment. Для кодов маркировки предусмотрен отдельный раздел «Маркировка» со сканированием и контролем партий.">
          ...
          <div><h3>Карточки marketplace</h3><ul><li><code>/catalog</code> — рабочая карточка Product/PIM: текст, SKU, цены, категории и изображения.</li><li><code>/publication-quality</code> проверяет готовность, а <code>/marketplace-publications</code> запускает snapshot preflight и показывает статус публикации/reconciliation.</li><li>Provider-specific атрибуты и массовое применение остаются qualification-required, пока нет официального connector evidence.</li></ul></div>
