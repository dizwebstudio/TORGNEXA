...
function IntegrationConnectionGuide() {
  return <>
    ...
    <div className="docs-table-wrap"><table className="docs-route-table"><thead><tr><th>Карточка</th><th>Учётные данные</th><th>Параметры среды / результат проверки</th></tr></thead><tbody>
      ...
      <tr><td><strong>Деловые Линии</strong></td><td>Учётные данные провайдера</td><td>После <code>healthy</code> доступны bounded чтение терминалов/ПВЗ и отслеживание истории статусов по номеру документа; тарифы и операции отправлений требуют отдельной qualification.</td></tr>
