...
if command -v go >/dev/null 2>&1; then
  ...
  docker run --rm --network host \
    ...
    -e TORGNEXA_MARKETPLACE_SMOKE_WB_TOKEN \
    -e TORGNEXA_MARKETPLACE_SMOKE_WB_WAREHOUSE_ID \
    -e TORGNEXA_MARKETPLACE_SMOKE_WB_VARIANT_ID \
    -e TORGNEXA_MARKETPLACE_SMOKE_OZON_CLIENT_ID \
    -e TORGNEXA_MARKETPLACE_SMOKE_OZON_API_KEY \
    -e TORGNEXA_MARKETPLACE_SMOKE_OZON_WAREHOUSE_ID \
    -e TORGNEXA_MARKETPLACE_SMOKE_OZON_OFFER_ID \
