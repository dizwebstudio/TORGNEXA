...
check: fmt-check test vet contracts architecture migrations policy sandbox conformance connector-readiness-qualification financial-completeness-qualification performance sdk-check frontend-check js-policy p4-policy community-check package-index-check
build:
