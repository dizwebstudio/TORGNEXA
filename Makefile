...
check: fmt-check test vet contracts architecture migrations policy sandbox conformance performance sdk-check frontend-check js-policy p4-policy community-check
build:
