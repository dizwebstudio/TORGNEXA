...
// ConformanceCandidate exposes the deterministic 5Post adapter to the SDK
// conformance harness without using production credentials or network access.
...
func (c *ConformanceCandidate) Account(tenant conformance.Tenant) sdk.Account {
	...
	return sdk.Account{ID: "fivepost-conformance", OrganizationID: tenant.OrganizationID, WorkspaceID: tenant.WorkspaceID, ConnectorID: "fivepost", Family: Manifest().Family, Status: sdk.AccountActive, SecretReference: "sec:v1:0123456789abcdef0123456789abcdef", Version: 1, Health: sdk.Health{Status: sdk.HealthUnknown}, CreatedAt: at, UpdatedAt: at}
}
...
func (candidateSecrets) UseSecret(_ context.Context, _ sdk.SecretReference, callback func([]byte) error) error {
	...
	secret := []byte("synthetic-5post-key")
	defer clear(secret)
