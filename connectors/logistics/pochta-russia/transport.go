...
type Transport interface {
	...
	BatchByName(context.Context, []byte, sdk.LogisticsBatchLookupQuery) (sdk.LogisticsBatch, error)
	BatchOrders(context.Context, []byte, sdk.LogisticsBatchOrdersQuery) ([]sdk.LogisticsBatchOrder, error)
	OrderInBatch(context.Context, []byte, sdk.LogisticsOrderQuery) (sdk.LogisticsBatchOrder, error)
	SearchOrders(context.Context, []byte, sdk.LogisticsOrderSearchQuery) ([]sdk.LogisticsOrderSummary, error)
	ArchivedBatches(context.Context, []byte, sdk.LogisticsArchiveBatchQuery) ([]sdk.LogisticsBatch, error)
	...
	UpdateBatchSendingDate(context.Context, []byte, sdk.LogisticsBatchSendingDateRequest) (sdk.LogisticsBatchSendingDateUpdate, error)
	RestoreOrders(context.Context, []byte, sdk.LogisticsOrderRestoreRequest) (sdk.LogisticsOrderRestore, error)
