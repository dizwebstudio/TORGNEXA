...
func (candidateTransport) VerifyWebhook(context.Context, []byte, []byte, []byte) (string, string, string, string, error) {
	return "delivery:1", "payment.succeeded", "pay:1", "OKpay:1", nil
}
