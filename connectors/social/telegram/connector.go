...
func Manifest() sdk.Manifest {
	return sdk.Manifest{
		...
		Auth:         []sdk.AuthRequirement{{Kind: sdk.AuthBearer, SecretClass: "social.bot-token", Required: true}}, // #nosec G101 -- bot-token is a manifest classification label, not secret material.
