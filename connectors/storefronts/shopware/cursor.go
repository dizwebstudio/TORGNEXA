...
// nextCursor follows Shopware's own 1-indexed page/limit/total Criteria
// pagination contract (the total item count lives in the response body).
func nextCursor(page, limit, total int, fingerprint string) (string, error) {
	if page*limit >= total {
		return "", nil
	}
