...
type Transport interface {
	...
	Reference(context.Context, []byte, sdk.GovernmentReferenceRequest) (sdk.GovernmentReference, error)
...
func manifest() sdk.Manifest {
	return sdk.Manifest{ID: "egais", Name: "EGAIS UTM", Family: sdk.FamilyGovernment, Version: "1.0.0", SDKVersion: 1, Capabilities: []sdk.Capability{"government.documents.read", "government.documents.write", "government.inventory.read", "government.reconciliation.run", "government.references.read"}, Auth: []sdk.AuthRequirement{{Kind: sdk.AuthCertificate, SecretClass: "government.certificate", Required: true}}, RateLimit: sdk.RateLimitPolicy{MaxConcurrency: 2, MinIntervalMS: 250, RequestTimeoutMS: 30000, Retry: sdk.RetryPolicy{MaxAttempts: 4, BaseBackoffMS: 500, MaxBackoffMS: 30000}}}
}
func (c *Connector) ReadGovernmentDocument(ctx context.Context, a sdk.Account, r sdk.Runtime, q sdk.GovernmentDocumentRequest) (sdk.GovernmentDocument, error) {
	if q.Validate() != nil || sdk.RequireCapability(Manifest(), "government.documents.read") != nil {
...
func (c *Connector) WriteGovernmentDocument(ctx context.Context, a sdk.Account, r sdk.Runtime, q sdk.GovernmentWriteRequest) (sdk.GovernmentWriteResult, error) {
	if q.Validate() != nil || sdk.RequireCapability(Manifest(), "government.documents.write") != nil {
...
func (c *Connector) ReadGovernmentInventory(ctx context.Context, a sdk.Account, r sdk.Runtime, q sdk.GovernmentInventoryRequest) (sdk.GovernmentInventoryObservation, error) {
	...
	if out.Validate() != nil {
		return sdk.GovernmentInventoryObservation{}, remote(sdk.ErrorInternal, "invalid_remote_response", 0)
	}
	return out, nil
}
func (c *Connector) ReadGovernmentReference(ctx context.Context, a sdk.Account, r sdk.Runtime, q sdk.GovernmentReferenceRequest) (sdk.GovernmentReference, error) {
	if q.Validate() != nil || sdk.RequireCapability(Manifest(), "government.references.read") != nil {
		return sdk.GovernmentReference{}, remote(sdk.ErrorInvalidRequest, "request_rejected", 0)
	}
	var out sdk.GovernmentReference
	e := useSecret(ctx, r, a, func(s []byte) error { var x error; out, x = c.transport.Reference(ctx, s, q); return x })
	if e != nil {
		return sdk.GovernmentReference{}, e
	}
	if out.Validate() != nil {
