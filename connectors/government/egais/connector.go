...
var ErrTransport = errors.New("egais: transport unavailable")
...
func (c *Connector) Health(ctx context.Context, a sdk.Account, r sdk.Runtime) (sdk.Health, error) {
	...
	if pe != nil {
		return sdk.Health{Status: sdk.HealthUnavailable, ReasonCode: "utm_unavailable", CheckedAt: c.now().UTC()}, nil
	}
