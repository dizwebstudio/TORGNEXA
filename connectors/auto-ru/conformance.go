...
func NewConformanceCandidate(exe string) (*ConformanceCandidate, error) {
	...
	return &ConformanceCandidate{
		SandboxFixture: f,
		connector: New(candidateTransport{}, candidateConfig{}, func() time.Time {
			return time.Date(2026, 8, 11, 21, 30, 0, 0, time.UTC)
		}),
		idem:  map[string]string{},
		hooks: map[string]string{},
	}, nil
...
func (c *ConformanceCandidate) Account(t conformance.Tenant) sdk.Account {
	...
	return sdk.Account{
		ID: "auto-ru-conformance", OrganizationID: t.OrganizationID, WorkspaceID: t.WorkspaceID,
		ConnectorID: "auto-ru", Family: sdk.FamilyClassified, Status: sdk.AccountActive,
...
func (c *ConformanceCandidate) Probe(_ context.Context, r conformance.ProbeRequest) (conformance.ProbeResult, error) {
	...
	case conformance.ProbeRateLimited:
		return conformance.ProbeResult{}, remote(sdk.ErrorRateLimited, "rate_limited", "auto-ru", time.Second)
...
func (candidateTransport) Do(_ context.Context, r Request) (Response, error) {
	...
	if r.Path == "/1.0/dealer/account" {
		return Response{StatusCode: 200, Body: []byte(`{"account_id":42,"dealer_status":"ACTIVE"}`)}, nil
	}
...
func (candidateSecrets) UseSecret(_ context.Context, _ sdk.SecretReference, cb func([]byte) error) error {
	...
	b := []byte(`{"authorization":"synthetic-auto-ru-authorization-token-0123456789","session_id":"synthetic-auto-ru-session-0123456789"}`)
	defer clear(b)
	return cb(b)
}
