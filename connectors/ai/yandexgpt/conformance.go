...
func (c *ConformanceCandidate) Account(t conformance.Tenant) sdk.Account {
	...
	return sdk.Account{ID: "yandexgpt-conformance", OrganizationID: t.OrganizationID, WorkspaceID: t.WorkspaceID, ConnectorID: "yandexgpt", Family: sdk.FamilyAI, Status: sdk.AccountActive, SecretReference: "sec:v1:0123456789abcdef0123456789abcdef", Version: 1, Health: sdk.Health{Status: sdk.HealthUnknown}, CreatedAt: at, UpdatedAt: at}
}
...
func candidateRemote(cat sdk.ErrorCategory, code string, retry time.Duration) error {
	e, _ := sdk.NewRemoteError(cat, code, "yandexgpt-conformance", retry)
	return e
}
...
func (candidateTransport) Do(_ context.Context, _ Request) (Response, error) {
	raw, _ := json.Marshal(completionResponse{Result: completionResult{Alternatives: []alternative{{Message: message{Text: "ok"}}}}})
