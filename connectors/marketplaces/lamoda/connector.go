// Package lamoda contains the SDK boundary for the Lamoda Seller API.
...
// Connector exposes the provider-neutral Lamoda health-check contract.
type Connector struct {
	transport Transport
	now       func() time.Time
}

// New constructs a Lamoda connector over a host-mediated transport.
...
// Manifest returns the canonical Lamoda connector manifest.
func Manifest() sdk.Manifest { value, _ := sdk.CatalogManifest("lamoda"); return value }
