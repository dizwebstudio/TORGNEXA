...
func manifest() sdk.Manifest {
	return sdk.Manifest{ID: "diadoc", Name: "Kontur Diadoc", Family: sdk.FamilyEDO, Version: "1.0.0", SDKVersion: 1, Capabilities: []sdk.Capability{"edo.documents.read", "edo.documents.send", "edo.documents.sign_request"}, Auth: []sdk.AuthRequirement{{Kind: sdk.AuthAPIKey, SecretClass: "edo.credential", Required: true}}, RateLimit: sdk.RateLimitPolicy{MaxConcurrency: 2, MinIntervalMS: 200, RequestTimeoutMS: 30000, Retry: sdk.RetryPolicy{MaxAttempts: 4, BaseBackoffMS: 500, MaxBackoffMS: 30000}}}
}
