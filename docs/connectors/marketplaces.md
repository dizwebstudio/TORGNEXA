...
| [Yandex Market](yandex-market/README.md) | `inventory.read`, `inventory.write`, `notifications.receive`, `orders.read`, `prices.read`, `prices.write`, `products.read` | exact price and inventory updates | [audit](yandex-market/capability-audit.md), [spec](yandex-market/spec.md), [conformance](yandex-market/conformance-report.json), [reconciliation](yandex-market/reconciliation.md) |
