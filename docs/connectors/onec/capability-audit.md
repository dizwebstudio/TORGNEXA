...
| `erp.inventory.read` | granted | Configured accumulation-register `Balance()` read; exact decimal quantity; admitted by the built-in runtime registry as a separate ERP inventory reader. |
