...
базовых цен, остатков и заказов с входящей синхронизацией. Стандартные статусы
заказов также записываются через отдельный outbound-маршрут. Изменения
...
синхронизацией; создание/удаление заказов, пользовательские статусы и
webhook-события пока не заявляются как рабочие маршруты. Остаток доступен
только как единый storefront balance.
