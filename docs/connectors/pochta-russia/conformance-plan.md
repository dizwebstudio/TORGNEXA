...
детерминированное чтение пунктов выдачи и проверку здоровья без сети и боевых
credentials. Общий harness проверяет SDK v1, границу секретов, нормализацию
ошибок, tenant isolation, egress и sandbox.

Перед включением тарифов, оформления отправлений, документов, возвратов и трекинга
