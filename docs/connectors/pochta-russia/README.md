...
`return-barcode`. Формирование партии, передача в работу, отдельное возвратное
отправление остаются закрытыми. Возвратная этикетка для существующего RPO
...
ответы провайдера за границу host transport не выходят. Формирование партии и
передача её в работу по-прежнему закрыты.
