...
заказов. Формирование и hand-off партии остаются отдельными закрытыми
операциями.

Формирование партии, передача заказа в работу, отдельные возвратные
отправления, прочие документы и возвраты, не покрытые существующим RPO,
требуют актуальных
