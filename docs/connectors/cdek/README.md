...
отправление переводится в `unknown` для reconciliation. Labels, returns и
webhooks остаются закрытыми до отдельной квалификации актуальных контрактов,
read-after-write/reconciliation и непродакшен-проверки. Для таймаута DELETE
