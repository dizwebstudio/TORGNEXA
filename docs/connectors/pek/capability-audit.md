...
В production-каталоге пока доступна только проверка credentials. Запись
заявки, автоматическая отмена, вебхуки и печатные формы не включены в runtime
support до получения тестового кабинета, актуальных fixtures и проверки
идемпотентности.
