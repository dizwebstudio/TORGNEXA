...
The admitted baseline publishes text, one photo, 2–10 photo albums and one MP4 video to one configured channel; supports HTTPS URL buttons for text, single-photo and single-video messages. Single-message edit, bounded deletion, provider scheduling, inbound bot updates, callback buttons, comments and analytics are outside this admission.
