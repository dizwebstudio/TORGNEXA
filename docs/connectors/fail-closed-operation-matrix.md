...
| Почта России | партии (bounded read/archive-read/create/submit/archive/unarchive), тарифы, tracking, ПВЗ, label, возвратная этикетка для существующего RPO, создание одиночного заказа в backlog, cancel нового заказа, возврат для существующего RPO, отдельное возвратное отправление | прочие операции архива |
