...
| Деловые Линии | тарифы, отправление create (address-to-address и bounded terminal-to-terminal), заявка на отмену delivery/pickup от адреса, отмена Pre-Alert пакетной заявки, tracking, label, ПВЗ | отмена отдельного терминального заказа/ручной возврат |
| ПЭК | тарифы, bounded self-delivery shipment create, tracking, ПВЗ, отмена предварительного оформления, возврат одного принятого груза отправителю, одиночная PDF-этикетка, печатная форма заявки, пакетная PDF-печать одной заявки | отмена сформированного груза |
| Почта России | партии (bounded read/archive-read/create/submit/archive/unarchive/sending-date-update), поиск партии по имени, bounded чтение заказов внутри партии, поиск одного заказа по ID и поиск по номеру магазина, возврат заказов из сформированной партии в «Новые», тарифы, tracking, ПВЗ, label, возвратная этикетка для существующего RPO, формы заказа до/после партии, форма Ф103 партии, создание одиночного заказа в backlog, cancel нового заказа, возврат для существующего RPO, отдельное возвратное отправление (создание/редактирование/удаление) | прочие операции партий, документов и возвратов |
| 5Post | проверка кабинета, ПВЗ, тариф C2C, tracking, cancel, label, bounded create | прочие тарифы и коммерческие договоры |
...
| MAX | текстовая, фото/альбомная и видео-публикация через released-upload bridge, HTTPS-кнопки для публикаций, approval-bound редактирование и удаление одного сообщения, приём входящих webhooks через Inbox/outbox, подписка/отписка webhook через authenticated host route | — |
