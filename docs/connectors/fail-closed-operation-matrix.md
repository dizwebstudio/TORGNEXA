...
| Почта России | партии (bounded read/create/submit), тарифы, tracking, ПВЗ, label, возвратная этикетка для существующего RPO, создание одиночного заказа в backlog, cancel нового заказа, возврат для существующего RPO, отдельное возвратное отправление | отмена сформированной партии |
