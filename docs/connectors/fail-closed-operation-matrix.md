...
| Почта России | партии (bounded read), тарифы, tracking, ПВЗ, label, возвратная этикетка для существующего RPO, создание одиночного заказа в backlog, cancel нового заказа, возврат для существующего RPO | формирование партии, передача в работу, отдельное возвратное отправление |
